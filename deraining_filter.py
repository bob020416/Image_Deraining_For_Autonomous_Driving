...
def main(I, opt, iterations=1):
    ...
    # Save output images
    cv2.imwrite('output/resultfinal.jpg', Ih_final)
...
if __name__ == "__main__":
    ...
    if I is None:
        raise IOError(f"Image not found at path: {input_path}")
    
    # Run the main function with opt parameter (set to 0 or 1 based on your requirement)
    main(I, opt=1)
